...
from services.submission_service import add_submission_to_user, add_submission_to_problem, get_problem_submissions
...
def test_get_submissions(id):
    submissions = get_problem_submissions(id)
    print(submissions)

test_get_submissions(1)